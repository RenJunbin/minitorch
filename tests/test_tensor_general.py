...
def test_one_args(
    ...
    #print("tensor_fn address is ", tensor_fn)
    t2 = tensor_fn(t1)
    #print("t1 is ", t1, "t1.shape is ", t1.shape)
    #print("t2 is ", t2, "t2.shape is ", t2.shape)
...
#@settings(max_examples=25, suppress_health_check=[HealthCheck.data_too_large])      #i must improve this effiency of this code !!!
@pytest.mark.parametrize("fn", two_arg)
@pytest.mark.parametrize("backend", backend_tests)
